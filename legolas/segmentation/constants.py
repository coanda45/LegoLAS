...
SAM_CONFIG_2 = {
    ...
    32,
    "points_per_batch":
    SAM_DEFAULT_PARAMS["points_per_batch"],
    "pred_iou_thresh":
    0.94,
    "stability_score_thresh":
    SAM_DEFAULT_PARAMS["stability_score_thresh"],
    "stability_score_offset":
    SAM_DEFAULT_PARAMS["stability_score_offset"],
    "box_nms_thresh":
    0.5,
    "crop_n_layers":
    1,
    "crop_nms_thresh":
    SAM_DEFAULT_PARAMS["crop_nms_thresh"],
    "crop_overlap_ratio":
    SAM_DEFAULT_PARAMS["crop_overlap_ratio"],
    "crop_n_points_downscale_factor":
    SAM_DEFAULT_PARAMS["crop_n_points_downscale_factor"],
    "point_grids":
    SAM_DEFAULT_PARAMS["point_grids"],
